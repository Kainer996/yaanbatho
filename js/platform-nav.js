...
(function () {
  ...
  function build() {
    ...
    // ── RIGHT CABLE ──
    const cableR = document.createElement('div');
    cableR.className = 'lift-cable lift-cable-right';
    document.body.appendChild(cableR);
    ...
    // ── FOUR COGS — centered on cable x; top pinned to 0, bottom pinned via bottom CSS ──
    const cogDefs = [
      { cx: CX_LEFT,  atTop: true  },
      { cx: CX_LEFT,  atTop: false },
      { cx: CX_RIGHT, atTop: true  },
      { cx: CX_RIGHT, atTop: false },
    ];
