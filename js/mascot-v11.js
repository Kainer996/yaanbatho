...
(function () {
  ...
  // Floor: character feet at the very bottom of the viewport (the bottom red line area)
  function floorY() {
    return window.innerHeight - CFG.charH - 4;
  }
  ...
  function measureHeader() {
    ...
    _headerTopY = hBottom - CFG.charH; // feet ON the red line at header's bottom
  }
  ...
  function doGrapple() {
    ...
    const ty = headerY() + CFG.charH; // hook catches ON the red line
