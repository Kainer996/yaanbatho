...
- The unexplored world sleeps beneath the **usurper's shadow**: the Earth itself stays visible — dark seas, darkened continents, unmistakably our planet — but every detail of the land is lost to the dark. Nothing hides the world; it is simply unlit.
...
Villages and towns are home to **Peeps** (the provisional name for the humanoid little folk): small, stylised people with faces, arms, hands and walking legs. They keep their names, homes and work. Their simple, birdlike minds need care and gentle guidance in a realm led by clever birds. A robin can plan a harvest; the little folk may need reminding which end of the bucket goes up. Treat them warmly. This explicit 2026-09-05 correction supersedes v348’s mistaken bird-population description and restores the original little-folk silhouette. Actual bird companions, zombie-bird enemies and animals keep their species.
...
- A thirsty Peep walks to an available well and drinks there; a tired one returns home to sleep. They need somewhere to enjoy themselves too, and become visibly unhappy without it. Their needs and small daily journeys persist, with friendly nonsense chatter when greeted. A blocked path or absent service remains an unmet need, inviting the player's care.
...
- When the player frees a village, safe homes and useful yards give its little folk a reason to return. A new roof and a familiar face are the visible rewards of restoration.
...
- **Villages are simple; towns are industrious.** A lone village raises only the basics, in coins and timber: a Timber Cabin, a 🏹 Hunter-Gatherer Hut for its food, a Stone Well, a Cottage Row, an Alehouse, a Storehouse. No village build ever asks for stone to raise it. A village can WORK stone, though — the 🪨 Miners' Hut and the 🪚 Lumberjack Hut hold three villagers each and dig and fell for the settlement's own use. The great works — the Grain Farm, the Lumber Camp, the Quarry, the Chapel, the Market Hall — open only when three starred villages merge into a Town, and they are simply better: one villager in a Quarry out-digs three in a hut. That is what the merge buys. Hunter-gatherers first; fields, mines and markets when the folk stand together.
...
- **Cheer is not a luxury.** Bread, water and a roof each count for one share of a village's happiness; the alehouse counts for a quarter more. Folk who are fed, watered and housed with nowhere to drink are content, never happy — and a village that has never poured a pint cannot wear its merge star, however many folk it holds.
