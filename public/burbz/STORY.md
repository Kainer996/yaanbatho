...
- The folk build the way the folk are: **timber first, stone later**. A freed village's first roof is a log Timber Cabin. It stretches into a Timber Longhouse when the family grows — still logs, still no stone, because a village has no quarry to cut from. Only a Town rebuilds it as a Stone Cottage.
...
- **Villages are simple; towns are industrious.** A lone village raises only the basics, in coins and timber: a Timber Cabin, a 🏹 Hunter-Gatherer Hut for its food, a Stone Well, a Cottage Row, an Alehouse, a Storehouse. No village build ever asks for stone, at any level. The great works — the Grain Farm, the Lumber Camp, the Quarry, the Chapel, the Market Hall, the Stone Cottage, and the whole stone economy with them — open only when three starred villages merge into a Town. Hunter-gatherers first; fields, mines and markets when the folk stand together.
