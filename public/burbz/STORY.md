...
- **Villages are simple; towns are industrious.** A lone village raises only the basics, in coins and timber: a Timber Cabin, a 🏹 Hunter-Gatherer Hut for its food, a Stone Well, a Cottage Row, an Alehouse, a Storehouse. The great works — the Grain Farm, the Lumber Camp, the Quarry, the Chapel, the Market Hall, and the whole stone economy with them — open only when three starred villages merge into a Town. Hunter-gatherers first; fields, mines and markets when the folk stand together.
