(function(root, factory) {
  ...
  const TREEHOUSE_ROOMS = [
    ...
    { id:'tavern', label:'The Thirsty Owl', icon:'🍺', cost:60, branches:8, unlockLevel:2, floor:1, branch:'right', x:76, y:80, role:'tavern', effect:'Trailside taproom: birds you befriend on walking quests wait here — buy them a drink to recruit them.' },
