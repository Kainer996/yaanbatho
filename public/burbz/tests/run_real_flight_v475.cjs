/* Real flight v475 in the actual retained renderer with explicitly synthetic,
...
const root=path.resolve(__dirname,'..'),out=process.env.EVIDENCE_DIR||'/tmp/burbz-real-flight-v475',report={served:{},missing:[],checks:[],samples:{},errors:[],limits:['Actual retained renderer and loader with explicitly synthetic DEM/vector input.','Software WebGL at a phone viewport, not phone hardware.']};
