...
def test_release_and_all_changed_academy_cores_are_pwa_pinned():
    ...
    assert f"const BURBZ_BUILD = 'alderwing-living-settlements-v348-20260904';" in source
    cache_line = next(line for line in sw.splitlines() if line.startswith("const BURBZ_CACHE = "))
    assert cache_line.rstrip("';").endswith("alderwing-living-settlements-v348-20260904")
