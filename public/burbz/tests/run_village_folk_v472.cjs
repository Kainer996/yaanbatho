// Village folk v472 in a real phone browser: every villager and animal is one
...
const out=path.join(process.env.EVIDENCE_DIR || require('os').tmpdir(),'burbz-village-folk-v472-evidence');fs.mkdirSync(out,{recursive:true});
