...
const caches={
  keys:async()=>['burbz-old-v78','burbz-national-completion-v79-20260715','burbz-buzzard-history-v80-20260716','good-news-v4','quarry-pro-v2'],
...
'''
    ...
    assert json.loads(result.stdout) == ["burbz-old-v78", "burbz-national-completion-v79-20260715"]
