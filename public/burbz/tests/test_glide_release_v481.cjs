...
test('v481 ships together: build marker, cache, three worker lists, loader and consumers',()=>{
 ...
 const LATER=['alderwing-seamless-v482-20260925','academy-day-night-v483-20260925','desk-screen-v484-20260925','academy-garden-birds-v486-20260925'],shipped=[BUILD,...LATER],cache=sw.match(/const BURBZ_CACHE = '([^']+)'/)[1];
