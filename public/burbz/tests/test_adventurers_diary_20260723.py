...
def test_diary_core_is_included_and_cached_offline():
    ...
    assert 'src="diary_core.js?v=adventurers-diary-20260723"' in html
    assert sw.count("./diary_core.js?v=adventurers-diary-20260723") == 2  # assets + core shell
    assert "burbz-adventurers-diary-v114-20260723" in sw  # cache version bumped
