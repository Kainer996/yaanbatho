'use strict';
// Alderwing seamless v474: nothing pops as the viewer moves. The ground bends
...
const BUILD='alderwing-seamless-v474-20260925';
...
test('v474 ships together: build marker, cache, three worker lists, loader and consumers',()=>{
