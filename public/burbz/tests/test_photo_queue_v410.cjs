...
const accepted={found:true,accepted:true,verified:true,policy:'photo-gemini-v494',model:'gemini-vision',modelName:'gemini-3.8-flash',receiptId:'a'.repeat(64),confidence:.99,species:'European Robin',scientificName:'Erithacus rubecula'};
