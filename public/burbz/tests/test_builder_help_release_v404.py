...
def test_builder_dependencies_are_required_and_deployable():
    ...
    for name in ('building_work_core.js','building_work.js','building_work.css','village_walk.js','first_person_hud.js'):
        pin='builder-help-v404-20260914' if name=='building_work_core.js' else 'home-farming-v409-20260914' if name=='village_walk.js' else 'building-opening-v405-20260914' if name=='building_work.js' else 'builder-actions-v404b-20260914'
        url='./'+name+'?v='+pin
