...
assert.equal(crypto.createHash('sha256').update(steps).digest('hex'), 'fa7f408e81ead514b06df5fc712cd7ce035a37fbe828f96f7e1f21edcb0a1675', 'Lesson text, IDs, order and actions change only on purpose (v466 cut the opening story to four beats)');
