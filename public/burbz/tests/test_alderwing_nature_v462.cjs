'use strict';
// Alderwing nature v462: real-cover ground, varied plants, the distant land,
...
const BUILD='alderwing-nature-v462-20260924';
...
test('v462 ships together: build marker, cache, three worker lists, loader and updater',()=>{
 ...
 assert(html.includes("const BURBZ_BUILD = '"+BUILD+"';"));assert(/const BURBZ_CACHE = '[^']*-alderwing-nature-v462-20260924';/.test(sw));
