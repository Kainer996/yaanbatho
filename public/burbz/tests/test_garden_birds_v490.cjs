...
test('v490 ships together: build marker, cache, three worker lists, loaders and updater',()=>{
 ...
 const LATER=['home-hub-v491-20260925','asmr-sound-v492-20260925','quest-lines-v493-20260926','photo-merlin-v494-20260926','alderwing-water-v496-20260926'],shipped=[BUILD,...LATER],current=b=>shipped.includes(b);
