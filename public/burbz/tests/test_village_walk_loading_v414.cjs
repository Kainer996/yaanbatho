...
function fixture(){
 ...
 for(const name of ['FlightCraft','ShoreWater','OpenLandCore','WildernessPlacesCore','WildernessPlaces','BuildingWorkCore','BuildingWork','FirstPersonMap','FirstPersonHud','VillageHarvestScene','VillageHarvestCore','VillageHarvest','InteriorLifeCore','InteriorLife','AcademyFlightCore','AcademyFlight','BuildingRoomsCore','BuildingRoomsScene','BuildingRooms','VillageWalkScene','WorldSky','VillageWorldCore','WorldNatureCore','WorldNature','WorldHorizon','WorldWaterCore','WorldWater','VillageWorld','VillageDiscoveryContent','VillageDiscoveryCore','VillageDiscoveries'])context['Burbz'+name]={};
