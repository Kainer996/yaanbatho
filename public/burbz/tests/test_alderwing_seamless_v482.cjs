...
test('v482 ships together: build marker, cache, three worker lists, loader and consumers',()=>{
 ...
 const LATER=['academy-day-night-v483-20260925','desk-screen-v484-20260925','smooth-sky-plain-plot-v485-20260925','village-folk-v486-20260925'],shipped=[BUILD,...LATER],cache=sw.match(/const BURBZ_CACHE = '([^']+)'/)[1];
