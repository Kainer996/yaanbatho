...
const functions = ['tutorialFlowState','openingProgress','openingObjective','nextOpeningChapter','openingCareSatisfied','openingErrandsIntroduced','openingSupplyErrandAvailable','commitOpeningFlow','maybeGrantMerlinBarracksGift','maybeGrantMerlinKitchenGift','maybeGrantTutorialFalconRation','academyBuildingProgressLock','academyBuildBuilding','introduceKitchenShortage','startBirdExpedition','claimBirdExpedition','claimedExpeditionCount','openingGuidedQuestId','activePlayerQuests','activePlayerQuest','assignPlayerQuestLines','noteOpeningDiscoveryReviewed','burbzFeedFood','recordFeedReceipt','merlinTutorialResumePosition'];
