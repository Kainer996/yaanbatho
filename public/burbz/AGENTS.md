...
- **2026-08-24 — one symbol, one sheet, for every post in the game (Claude).**
  Release `one-tap-appointments-v319-20260824`, from Yaan's Kitchen screenshot.
...
- **2026-08-24 — villages first, and the county merge that a hidden tab ate
  (Claude).** Release `villages-first-county-merge-v318-20260824`, two
  follow-ups to v317.
