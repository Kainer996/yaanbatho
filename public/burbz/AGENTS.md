...
Landscape v388 (`landscape-v388-20260910`) is a local follow-up to released v387. At landscape widths of at least 640px, the normal game dock becomes a right-hand rail. Village/town overviews use the left half of the viewport below the shared header, with independently scrolling management on the right. The adapter moves existing stage nodes and restores their portrait positions; preserve DOM/listener/renderer identity, focus, full-screen walking, projected house-screen composition and existing saves. No landscape release is authorized yet. Details: [LANDSCAPE_V388.md](LANDSCAPE_V388.md).
