...
- **2026-08-13 — the world gets real names (Claude).** Yaan saw the map full
  ...
  words, the same for every player. Release `real-place-names-v263-20260813`.
  ...
  - Tests: `tests/test_unique_place_names_20260804.py` rewritten — the
    ...
    and UI contracts survive unchanged. Head pins swept v262→v263 (the v262
    suite kept its OWN_RELEASE_PIN per convention); the realm core's `?v=`
