...
Build: `paced-tutorial-v469-20260924`
...
- `node tests/test_paced_tutorial_v469.cjs` — lesson list, pacing rules, wiring and flight fixes.
- `node tests/run_paced_tutorial_v469.cjs` — real Chromium, phone size: 10 checks from the Home terminal to the Kitchen errand.
...
- Full suite against main (at v467): no new failures. Main already fails 311 pytest tests, 20 collection errors and 32 node tests; the sets are identical.
...
- Numbered v469: main shipped the five-beat story as v467 (PR #405) while this was built, and an unmerged branch holds v468. Main was merged in; only version bookkeeping clashed, and the lesson hash was re-pinned on the merged list.
