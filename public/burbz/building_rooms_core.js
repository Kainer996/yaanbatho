...
function plan({buildingId='cabin',seed=0,homeId='',variant,scope}={}){
 ...
 if(buildingId==='tavern'){p.props=p.props.filter(o=>!(o.type==='table'&&o.x>0));put('commanddesk',3.5,.2);put('armchair',3.5,1.8,2);p.deskAction={x:3.5,z:3,kind:'command-desk',label:'Sit at the command desk'};}
 return p;
}
