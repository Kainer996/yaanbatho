...
(function(root){'use strict';
 ...
 function attach(s){
  ...
  const climb=host.querySelector('.cw-wings')&&host.querySelector('button[aria-label="Flap"]'),descend=host.querySelector('.cw-wings')&&host.querySelector('button[aria-label="Dive"]');climb?.classList.add('wc-climb');descend?.classList.add('wc-descend');
