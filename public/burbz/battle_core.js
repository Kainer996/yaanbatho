...
(function(root, factory) {
  ...
  const SIGNATURES = [
    ...
    { match:['rook'], label:'Blackfeather Hex', power:118, aoe:true, crShred:0.2, rider:{ kind:'debuff', stat:'def', pct:0.3, turns:3 }, fact:'Rooks solve multi-step problems and have bent wire into hooks in experiments.' },
    { match:['crow','raven','jackdaw'], label:'Mob Rule', power:84, aoe:true, rider:{ kind:'debuff', stat:'atk', pct:0.2, turns:2 }, fact:'Corvids recruit the whole neighbourhood to drive off raptors.' },
